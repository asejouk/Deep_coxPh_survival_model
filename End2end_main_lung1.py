...
def negloglik_risk_function(features, month, status):
    ...
    affine = tf.reduce_sum(features, axis= 1)
    affine = tf.expand_dims(affine, -1)

    # condition to normalize greater than one feature
    affine =  tf.divide(affine - tf.reduce_mean(affine), tf.reduce_max(affine)-tf.reduce_min(affine))
    print(tf.reduce_mean(affine),tf.reduce_max(affine),tf.reduce_min(affine))
...
for k_fold_num in range(k_fold_split):
    ...
    #
        ...
        train_var1 = [var for var in tf.trainable_variables() if  (not 'CTpet_output2/' in var.name) and  (not 'CTpet_output3/' in var.name) and  (not 'CTpet_output4/' in var.name) and (not 'FC_layers' in var.name) and (not 'CTpet_output1/InceptionV4/Logits/Logits' in var.name) and  (not 'CTpet_output1/InceptionV4/AuxLogits' in var.name) and (not 'CTpet_output1/InceptionV4/Conv2d_1a_3x3' in var.name) and (not 'CTpet_output1/InceptionV4/Conv2d_2a_3x3' in var.name) and (not 'CTpet_output1/InceptionV4/Conv2d_2b_3x3' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_3' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_4' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_5' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6a' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6b' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6c' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6d' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6e' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6f' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6g' in var.name)]

        train_var11 = [var for var in tf.trainable_variables() if  (not 'CTpet_output2/' in var.name) and  (not 'CTpet_output3/' in var.name) and  (not 'CTpet_output4/' in var.name) and (not 'FC_layers' in var.name) and (not 'CTpet_output1/InceptionV4/Logits/Logits' in var.name) and  (not 'CTpet_output1/InceptionV4/AuxLogits' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_7' in var.name) and (not 'CTpet_output1/InceptionV4/Conv2d_1a_3x3' in var.name) and (not 'CTpet_output1/InceptionV4/Conv2d_2a_3x3' in var.name) and (not 'CTpet_output1/InceptionV4/Conv2d_2b_3x3' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_3' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_4' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_5' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6h' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6a' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6b' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6c' in var.name) and (not 'CTpet_output1/InceptionV4/Mixed_6d' in var.name)]


        train_var2 = [var for var in tf.trainable_variables() if (not 'CTpet_output1/' in var.name) and  (not 'CTpet_output3/' in var.name) and  (not 'CTpet_output4/' in var.name) and (not 'FC_layers' in var.name) and (not 'CTpet_output2/InceptionV4/Logits/Logits' in var.name) and  (not 'CTpet_output2/InceptionV4/AuxLogits' in var.name) and (not 'CTpet_output2/InceptionV4/Conv2d_1a_3x3' in var.name) and (not 'CTpet_output2/InceptionV4/Conv2d_2a_3x3' in var.name) and (not 'CTpet_output2/InceptionV4/Conv2d_2b_3x3' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_3' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_4' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_5' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6b' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6c' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6d' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6e' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6f' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6g' in var.name)]

        train_var22 = [var for var in tf.trainable_variables() if (not 'CTpet_output1/' in var.name) and  (not 'CTpet_output3/' in var.name) and  (not 'CTpet_output4/' in var.name) and (not 'FC_layers' in var.name) and (not 'CTpet_output2/InceptionV4/Logits/Logits' in var.name) and  (not 'CTpet_output2/InceptionV4/AuxLogits' in var.name)  and (not 'CTpet_output2/InceptionV4/Mixed_7' in var.name) and (not 'CTpet_output2/InceptionV4/Conv2d_1a_3x3' in var.name) and (not 'CTpet_output2/InceptionV4/Conv2d_2a_3x3' in var.name) and (not 'CTpet_output2/InceptionV4/Conv2d_2b_3x3' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_3' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_4' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_5' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6h' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6a' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6b' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6c' in var.name) and (not 'CTpet_output2/InceptionV4/Mixed_6d' in var.name)]


        train_var3 = [var for var in tf.trainable_variables() if  (not 'CTpet_output1/' in var.name) and  (not 'CTpet_output2/' in var.name) and  (not 'CTpet_output4/' in var.name) and (not 'FC_layers' in var.name) and (not 'CTpet_output3/InceptionV4/Logits/Logits' in var.name) and  (not 'CTpet_output3/InceptionV4/AuxLogits' in var.name) and (not 'CTpet_output3/InceptionV4/Conv2d_1a_3x3' in var.name) and (not 'CTpet_output3/InceptionV4/Conv2d_2a_3x3' in var.name) and (not 'CTpet_output3/InceptionV4/Conv2d_2b_3x3' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_3' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_4' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_5' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6b' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6c' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6d' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6e' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6f' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6g' in var.name)]

        train_var33 = [var for var in tf.trainable_variables() if  (not 'CTpet_output1/' in var.name) and  (not 'CTpet_output2/' in var.name) and  (not 'CTpet_output4/' in var.name) and (not 'FC_layers' in var.name) and (not 'CTpet_output3/InceptionV4/Logits/Logits' in var.name) and  (not 'CTpet_output3/InceptionV4/AuxLogits' in var.name)  and (not 'CTpet_output3/InceptionV4/Mixed_7' in var.name) and (not 'CTpet_output3/InceptionV4/Conv2d_1a_3x3' in var.name) and (not 'CTpet_output3/InceptionV4/Conv2d_2a_3x3' in var.name) and (not 'CTpet_output3/InceptionV4/Conv2d_2b_3x3' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_3' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_4' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_5' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6h' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6a' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6b' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6c' in var.name) and (not 'CTpet_output3/InceptionV4/Mixed_6d' in var.name)]


        train_var4 = [var for var in tf.trainable_variables() if (not 'CTpet_output1/' in var.name) and  (not 'CTpet_output2/' in var.name) and  (not 'CTpet_output3/' in var.name) and (not 'FC_layers' in var.name) and (not 'CTpet_output4/InceptionV4/Logits/Logits' in var.name) and  (not 'CTpet_output4/InceptionV4/AuxLogits' in var.name) and (not 'CTpet_output4/InceptionV4/Conv2d_1a_3x3' in var.name) and (not 'CTpet_output4/InceptionV4/Conv2d_2a_3x3' in var.name) and (not 'CTpet_output4/InceptionV4/Conv2d_2b_3x3' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_3' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_4' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_5' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6b' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6c' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6d' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6e' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6f' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6g' in var.name)]

        train_var44 = [var for var in tf.trainable_variables() if (not 'CTpet_output1/' in var.name) and  (not 'CTpet_output2/' in var.name) and  (not 'CTpet_output3/' in var.name) and (not 'FC_layers' in var.name) and (not 'CTpet_output4/InceptionV4/Logits/Logits' in var.name) and  (not 'CTpet_output4/InceptionV4/AuxLogits' in var.name)  and (not 'CTpet_output4/InceptionV4/Mixed_7' in var.name) and (not 'CTpet_output4/InceptionV4/Conv2d_1a_3x3' in var.name) and (not 'CTpet_output4/InceptionV4/Conv2d_2a_3x3' in var.name) and (not 'CTpet_output4/InceptionV4/Conv2d_2b_3x3' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_3' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_4' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_5' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6h' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6a' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6b' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6c' in var.name) and (not 'CTpet_output4/InceptionV4/Mixed_6d' in var.name)]
        ...
        with tf.Session(config = config) as sess:
            ...
            for epoch in range(num_epochs):
                ...
                for batch in range(n_batch):
                    ...
                    print('batch risk score shape for batch number and epoch number----:',train_risk, batch, epoch)
